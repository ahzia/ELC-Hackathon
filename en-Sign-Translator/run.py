...
def evaluate(encoder, decoder, sentence, max_length=1):
...
#    print(encoder_hidden[0])	
 ...
 #       print(input_variable)
        print(input_variable)#,encoder_hidden)
        encoder_output, encoder_hidden = encoder(input_variable[0], encoder_hidden)
...
#    print(input_lang.n_words)
    ...
    while True:
        input_string = normalize_en("world")#input("> "))
