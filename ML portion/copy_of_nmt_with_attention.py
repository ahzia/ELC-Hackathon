...
Original file is located at
    https://colab.research.google.com/drive/1Pod_bMzmPl1N_UoQvvMdjE-KkpXETvxg
...
#must on encoding ...
#this part have errors
#mount files from drive
#open the data set
#path_to_file="My Drive/Final Project Dataset/Sign with Tabs.txt"
#path_to_file = os.path.dirname("/drive/My Drive/Final Project Dataset/Sign with Tabs.txt")
#wich encoding is suitable
#dataset = open("/content/drive/My\ Drive/Final Project Dataset/Sign with Tabs.txt", "r").read()
#dataset = open("Sign with Tabs.txt", "r").read()
...
sp_sentence = u"𝠀񀀁񀀉񇑅񇑑񆫡񆫡񋸦𝠃𝤯𝤮񀀁𝤕𝣨񀀉𝣩𝣼񇑑𝣞𝤝񇑅𝤈𝤇񆫡𝤚𝣟񆫡𝣡𝣳񋸦𝤊𝤛𝠀񀀁񀊑񈝥𝠃𝤑𝤦񀀁𝤀𝣧񀊑𝣼𝤌"
